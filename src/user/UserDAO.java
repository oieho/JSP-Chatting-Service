...
DataSource dataSource;
	...
	public String getProfile(String userID) {
		...
		try {
			...
			if (rs.next() || userID.equals("")) {
				if(rs.getString("userProfile").equals("")) {
					return "http://localhost:9087/JSP-Chatting-Service/images/icon.jpg";
				}
				return "http://localhost:9087/JSP-Chatting-Service/upload/" + rs.getString("userProfile");
			} 
		...
		return "http://localhost:9087/JSP-Chatting-Service/images/icon.jpg"; // 데이터베이스 오류
	}
}
